...
const OrganizationManagementTab = dynamic(
  () => import("@/components/settings/OrganizationManagementTab"),
  { ssr: false },
);
...
const AdminConfigTab = dynamic(
  () => import("@/components/settings/AdminConfigTab"),
  { ssr: false },
);
const NotificationsTab = dynamic(
  () => import("@/components/settings/NotificationsTab"),
  { ssr: false },
);
const EmailSettingsTab = dynamic(
  () => import("@/components/settings/EmailSettingsTab"),
  { ssr: false },
);
const SuperAdminConfigTab = dynamic(
  () => import("@/components/settings/SuperAdminConfigTab"),
  { ssr: false },
);
const ArchivalSettingsTab = dynamic(
  () => import("@/components/settings/ArchivalSettingsTab"),
  { ssr: false },
);
...
const DateTimeSettingsTab = dynamic(
  () => import("@/components/settings/DateTimeSettingsTab"),
  { ssr: false },
);
...
export default function SettingsPage() {
  const [activeTab, setActiveTab] = useState<TabName>("organization");
  ...
  const tabs: Tab[] = [
    ...
    // Role Management moved to Client Dashboard
    {
      id: "organization",
      name: "Organization",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">
            Manage global system configuration and organization defaults
          </p>
        </div>
