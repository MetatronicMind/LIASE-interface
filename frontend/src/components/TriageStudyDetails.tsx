...
export default function TriageStudyDetails({
  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-6">
      ...
      {(study.aiInferenceData?.Abstract || study.abstract) && (
        <div className="bg-gray-50 rounded-lg p-4">
          ...
          <div className="bg-white rounded p-4 border">
            <p className="text-gray-900 leading-relaxed text-sm">{study.aiInferenceData?.Abstract || study.abstract}</p>
          </div>
        </div>
      )}
        ...
        <div className="space-y-4">
          ...
          {(study.special_case || study.specialCase) && (
              <div>
                ...
                <p className="mt-1 text-gray-900">{study.special_case || study.specialCase}</p>
              </div>
            )}
            ...
            {(study.Text_type || study.textType) && (
              <div>
                ...
                <p className="mt-1 text-gray-900">{study.Text_type || study.textType}</p>
              </div>
            )}
          ...
          {study.attributability && (
            <div>
              ...
              <p className="mt-1 text-gray-900 text-sm">{study.attributability}</p>
            </div>
          )}
          {study.drugEffect && (
            <div>
          ...
          {study.justification && (
            <div>
              ...
              <p className="mt-1 text-gray-900 text-sm">{study.justification}</p>
            </div>
          )}
