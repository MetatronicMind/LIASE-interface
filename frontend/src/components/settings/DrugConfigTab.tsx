    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Configure availability for drug search schedules
          </p>
        </div>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
        <h3 className="text-lg font-medium text-gray-900 mb-4">
          Weekly Search Allowed Days
        </h3>
        <p className="text-sm text-gray-600 mb-6">
          Select the days of the week that users are allowed to schedule weekly
          drug searches. Users will only see these days in the dropdown when
          configuring a weekly search.
        </p>
