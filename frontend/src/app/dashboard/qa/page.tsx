  ...
  const approveClassification = async (studyId: string) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setComments("");
        alert("classification approved successfully! Study will proceed to Data Entryer.");
        fetchPendingStudies();
      } else {
  ...
  const rejectClassification = async (studyId: string) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert("classification rejected successfully! Study has been returned to Data Entry for corrections.");
        fetchPendingStudies();
      } else {
