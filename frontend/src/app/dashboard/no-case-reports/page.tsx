...
export default function NoCaseReportsPage() {
  ...
  const fetchStudies = async () => {
    try {
      ...
      const response = await fetch(
        `${getApiBaseUrl()}/studies/no-case-reports?${params}`,
      ...
      console.error("Error fetching No Case Reports:", error);
    } finally {
      setLoading(false);
    }
  };
  ...
  const exportReport = () => {
    ...
    a.href = url;
    a.download = `NoCase_Report_${selectedStudy.pmid}_${new Date().toISOString().split("T")[0]}.json`;
  ...
  const exportToCSV = () => {
    ...
    add("NoCase", "Text Type", selectedStudy.textType || selectedStudy.Text_type);
    add("NoCase", "Listedness", selectedStudy.listedness);
    add("NoCase", "Seriousness", selectedStudy.seriousness);
    add("NoCase", "Serious", selectedStudy.serious ? "Yes" : "No");
    add("NoCase", "DOI", selectedStudy.doi);
    add("NoCase", "Special Case", selectedStudy.specialCase);
    add("NoCase", "Country of First Author", selectedStudy.countryOfFirstAuthor);
    add("NoCase", "Country of Occurrence", selectedStudy.countryOfOccurrence);
    add("NoCase", "Attributability", selectedStudy.attributability);
    add("NoCase", "Drug Effect", selectedStudy.drugEffect);
    add("NoCase", "Author Perspective", selectedStudy.authorPerspective);
    add("NoCase", "Substance Group", selectedStudy.substanceGroup);
    add("NoCase", "Lead Author", selectedStudy.leadAuthor);
    add("NoCase", "Test Subject", selectedStudy.testSubject);
    add("NoCase", "Sponsor", selectedStudy.sponsor);
    add("NoCase", "Client Name", selectedStudy.clientName);
    add("NoCase", "Patient Details", selectedStudy.patientDetails);
    add("NoCase", "Key Events", selectedStudy.keyEvents);
    add("NoCase", "Administered Drugs", selectedStudy.administeredDrugs);
    add("NoCase", "Relevant Dates", selectedStudy.relevantDates);
    add("NoCase", "Summary", selectedStudy.summary);
    add("NoCase", "Vancouver Citation", selectedStudy.vancouverCitation);
    add("NoCase", "Identifiable Human Subject", selectedStudy.identifiableHumanSubject ? "Yes" : "No");
    add("NoCase", "Justification", selectedStudy.justification);
    ...
    const a = document.createElement("a");
    a.href = url;
    a.download = `NoCase_Report_${selectedStudy.pmid}_${new Date().toISOString().split("T")[0]}.csv`;
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
    URL.revokeObjectURL(url);
        ...
        <div className="p-6 max-w-7xl mx-auto">
          <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
            ...
            <p className="text-red-600">
              You don&apos;t have permission to view No Case Reports.
            </p>
          </div>
        </div>
      }
      ...
      <div className="p-6 max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Review confirmed No Case articles that have been approved through
            assessment
          </p>
        </div>
          ...
          <>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 mb-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                <FunnelIcon className="w-5 h-5 mr-2 text-slate-600" />
                Filter Reports
              </h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <MagnifyingGlassIcon className="w-5 h-5 text-slate-500 absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none" />
                    <input
                      type="text"
                      placeholder="Search No Case articles..."
                      value={searchTerm}
                      onChange={(e) => {
                        setSearchTerm(e.target.value);
                        setCurrentPage(1);
                      }}
                      className="w-full pl-10 pr-4 py-3 border border-slate-400 rounded-lg text-sm focus:ring-2 focus:ring-slate-500 focus:border-slate-500 bg-white transition-colors text-gray-900"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 border border-slate-400 rounded-lg text-sm focus:ring-2 focus:ring-slate-500 focus:border-slate-500 bg-white text-gray-900"
                  >
              ...
              <div className="grid gap-6">
                {studies.map((study) => (
                  ...
                  >
                    ...
                    {(study.textType || study.Text_type) && (
                ...
                {studies.length === 0 && !loading && (
                  <div className="text-center py-12 text-gray-500">
                    ...
                    No No Case articles in the reporting stage yet.
                  </div>
                )}
              </div>
            )}
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg w-full max-w-[95vw] max-h-[90vh] overflow-hidden">
              ...
              <div className="flex justify-between items-center p-6 border-b border-gray-200">
                <div>
                  <h2 className="text-xl font-bold text-black">
                    No Case Full Report — {selectedStudy?.title}
                  </h2>
                ...
                <div className="flex gap-2">
                  <div className="relative">
                    <button
                      ...
                      className="px-4 py-2 bg-slate-600 text-white rounded-md hover:bg-slate-700 text-sm font-medium flex items-center gap-2"
                    >
                      Export Report
                      <svg
                        className="w-4 h-4"
              ...
              <div className="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
                ...
                {/* No Case Assessment Data */}
                <div className="mb-8 p-4 bg-gray-50 rounded-lg border border-gray-200">
                  <h3 className="text-lg font-semibold text-black mb-3">
                    No Case Assessment Data
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {(selectedStudy?.textType || selectedStudy?.Text_type) && (
                      <div>
                        <p className="text-sm font-medium text-black">
                          Text Type:
                        </p>
