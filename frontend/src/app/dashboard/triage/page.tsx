    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      ...
      <div className="bg-white border-b border-gray-200 px-4 sm:px-6 py-4">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="mt-1 text-sm text-gray-600">Classify studies as ICSR, AOI, or No Case for pharmacovigilance processing</p>
        </div>
      </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
                          {selectedStudy.ICSR_classification && (
                            <div>
                              ...
                              <p className="mt-1 text-gray-900">{selectedStudy.ICSR_classification}</p>
                            </div>
                          )}
                          {selectedStudy.special_case && (
                            <div>
                              <span className="font-medium text-gray-700">Special Case:</span>
                              <p className="mt-1 text-gray-900">{selectedStudy.special_case}</p>
                            </div>
                          )}
                          {selectedStudy.Serious && (
                            <div>
                              <span className="font-medium text-gray-700">Serious:</span>
                              <p className="mt-1 text-gray-900">{selectedStudy.Serious}</p>
                            </div>
                          )}
                          {selectedStudy.Text_type && (
                            <div>
                              <span className="font-medium text-gray-700">Text Type:</span>
                              <p className="mt-1 text-gray-900">{selectedStudy.Text_type}</p>
                            </div>
                          )}
                          ...
                          {selectedStudy.serious !== undefined && (
                            <div>
                              ...
                              <p className="mt-1 text-gray-900">{selectedStudy.serious ? 'Yes' : 'No'}</p>
                            </div>
                          )}
                        </div>
                      </div>
