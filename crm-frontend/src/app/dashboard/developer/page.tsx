            ...
            {environments.map((env) => (
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <Link href={`/dashboard/developer/environments/${env.id}`}>
                      <h3 className="font-bold text-lg text-gray-800 hover:text-indigo-600 cursor-pointer">
                        {env.name}
                      </h3>
                    </Link>
                    <p
                ...
                <div className="mt-4">
                  <Link
                    href={`/dashboard/developer/environments/${env.id}`}
                    className="flex items-center justify-center w-full py-2 px-4 mb-3 rounded-md font-medium text-indigo-700 bg-indigo-50 border border-indigo-200 hover:bg-indigo-100 transition-all text-sm"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
